...
import { containingBlock, establishesBFC, horizontalNonContent, horizontalMargin, inFlow, resolveWidthBlock, verticalNonContent, } from "../utils/node-math.js";
...
export class BlockLayoutStrategy {
    supportedDisplays = new Set([Display.Block, Display.FlowRoot, Display.InlineBlock]);
    canLayout(node) {
