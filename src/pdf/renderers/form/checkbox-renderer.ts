...
import { drawCheckbox, drawCheckmark } from "./shape-utils.js";

const DEFAULT_CHECKBOX_SIZE = 16;

export class CheckboxRenderer implements IFormRenderer {
  readonly elementType = 'checkbox';
  ...
  render(node: RenderBox, context: RenderContext): RenderCommands {
    ...
    const size = Math.min(rect.width, rect.height, DEFAULT_CHECKBOX_SIZE);
    ...
    const checkColor: RGBA = { r: 0.2, g: 0.4, b: 0.8, a: 1 };
